...
@protocol ASStarRatingViewProtocol;
...
@property (nonatomic,strong) id<ASStarRatingViewProtocol> delegate;
@end
@protocol ASStarRatingViewProtocol <NSObject>

@optional
- (void)starsSelectionChanged:(ASStarRatingView*)control rating:(float)rating;
