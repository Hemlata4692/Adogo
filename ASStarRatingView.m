...
- (void)baseInit {
    _notSelectedStar = [[UIImage imageNamed:@"star_gray"] retain];
    _selectedStar = [[UIImage imageNamed:@"star"] retain];
    _halfSelectedStar = [[UIImage imageNamed:@"half-star"] retain];
...
- (void)setDelegate:(id<ASStarRatingViewProtocol>)delegate
{
    _delegate = delegate;
}
